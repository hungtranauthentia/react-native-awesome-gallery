...
exports.default = exports.GalleryMediaType = exports.snapPoint = void 0;
...
const defaultRenderImage = ({
  ...
  if (item.type !== GalleryMediaType.VIDEO) return /*#__PURE__*/_react.default.createElement(_reactNative.Image, {
    onLoad: e => {
      const {
        height: h,
        width: w
...
let GalleryMediaType;
exports.GalleryMediaType = GalleryMediaType;

(function (GalleryMediaType) {
  GalleryMediaType["VIDEO"] = "video";
  GalleryMediaType["IMAGE"] = "image";
})(GalleryMediaType || (exports.GalleryMediaType = GalleryMediaType = {}));
