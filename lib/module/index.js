...
const ResizableImage = /*#__PURE__*/React.memo(({
  ...
  return /*#__PURE__*/React.createElement(GestureDetector, {
    gesture: (item === null || item === void 0 ? void 0 : item.type) === 'video' ? Gesture.Race(panGesture, pinchGesture) : Gesture.Race(Gesture.Simultaneous(longPressGesture, Gesture.Race(panGesture, pinchGesture)), Gesture.Exclusive(doubleTapGesture, tapGesture))
